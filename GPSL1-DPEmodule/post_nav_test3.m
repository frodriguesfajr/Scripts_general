...
for currMeasNr = 1:measNrSum
    ...
    activeChnList = intersect(find(satElev >= ...
        settings.elevationMask), readyChnList);
    navSolutions_PRN(activeChnList, currMeasNr) = ...
            ...
            for ind = 1:nmbOfSatellites
                if iter == 1
                    ...
                    % disp(traveltime)
                     ...
                     Rot_X = e_r_corr(traveltime, X(:, ind));
                     disp(Rot_X)
                     % X_sat = X(:, i);
                end
            end
...
%         disp(navSolutions_X(currMeasNr))
%         return
...
%         %                                navSolutions_longitude(currMeasNr));
%         % disp(navSolutions_utmZone)
%         latitude = navSolutions_latitude(currMeasNr);
%         longitude = navSolutions_longitude(currMeasNr);
