...
addpath ('C:\Repository\GPSL1-DPEmodule\include')               % The software receiver functions
addpath ('C:\Repository\GPSL1-DPEmodule\Common')         % Common functions between differnt SDR receivers
addpath ('C:\Repository\GPSL1-DPEmodule\IF_Data_Set')    % IF data sets for each SDR receivers
%% Print startup ==========================================================
fprintf(['\n',...
    'Welcome to:  softGNSS\n\n', ...
